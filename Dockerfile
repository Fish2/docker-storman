...
curl -o /tmp/msm_linux.tgz http://download.adaptec.com/raid/storage_manager/msm_linux_x64_v3_00_23484.tgz && \
tar -xf /tmp/msm_linux.tgz -C /tmp && \
DEBIAN_FRONTEND=noninteractive dpkg -i /tmp/manager/StorMan-3.00-23484_amd64.deb && \
apt-get autoremove -y && apt-get clean && \
rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/*

# Ports, Entry Points and Volumes
EXPOSE 8443
ENTRYPOINT /etc/init.d/stor_restfulserver start && /etc/init.d/stor_tomcat start
